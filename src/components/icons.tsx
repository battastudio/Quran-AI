...
const P: Record<string, string> = {
  ...
  volume: 'M4 9v6h4l5 4V5L8 9zM16 8a5 5 0 0 1 0 8',
  compass: 'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zM15 9l-2 4-4 2 2-4z',
  moon: 'M20 14a8 8 0 1 1-9-11 6 6 0 0 0 9 11z',
  cloud: 'M7 18a4 4 0 0 1 0-8 5 5 0 0 1 9.6-1A3.5 3.5 0 0 1 17 18z',
  beads: 'M5 6a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM12 6a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM19 6a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM12 14v6',
  hands: 'M7 11V6a1.5 1.5 0 0 1 3 0M10 11V5a1.5 1.5 0 0 1 3 0v6M13 11V6a1.5 1.5 0 0 1 3 0v7a5 5 0 0 1-5 5H9l-4-4',
};
